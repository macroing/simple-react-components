  ...
  return (
    <nav className={styles.breadcrumb_container}>
      ...
      <ul className={styles.breadcrumb_mobile}>
        {items.length > 0 && <li className={styles.item}>{items[0].href ? <Link href={items[0].href}>{items[0].text}</Link> : <span>{items[0].text}</span>}</li>}
        {items.length > 3 && (
        ...
        {items.length > 1 && <li className={styles.item}>{items[items.length - 2].href ? <Link href={items[items.length - 2].href}>{items[items.length - 2].text}</Link> : <span>{items[items.length - 2].text}</span>}</li>}
        {items.length > 2 && <li className={styles.item}>{items[items.length - 1].href ? <Link href={items[items.length - 1].href}>{items[items.length - 1].text}</Link> : <span>{items[items.length - 1].text}</span>}</li>}
      </ul>
    </nav>
  );
}
